package ai.h2o.hive.udf.models;/*
  ...
  AUTOGENERATED BY H2O at 2016-03-16T13:30:33.853-07:00
  3.8.1.3
  
  Standalone prediction code with sample test data for GLMModel named glm6

  How to download, compile and execute:
      mkdir tmpdir
      cd tmpdir
      curl http://127.0.0.1:54321/3/h2o-genmodel.jar > h2o-genmodel.jar
      curl http://127.0.0.1:54321/3/Models.java/glm6 > glm6.java
      javac -cp h2o-genmodel.jar -J-Xmx2g -J-XX:MaxPermSize=128m glm6.java
...
@ModelPojo(name="glm6", algorithm="glm")
public class glm6 extends GenModel {
  ...
  public static final String[] NAMES = NamesHolder_glm6.VALUES;
  ...
  public glm6() { super(NAMES,DOMAINS); }
  public String getUUID() { return Long.toString(-7033482313658636593L); }
    ...
    static class BETA implements java.io.Serializable {
      ...
      static final class BETA_0 implements java.io.Serializable {
        static final void fill(double[] sa) {
          sa[0] = -9.496910331993108;
          sa[1] = 3.579714966015209;
          sa[2] = 25.27700388354628;
          sa[3] = 6.66316307517571;
        }
      }
}
// Imputed numeric values
    static class NUM_MEANS implements java.io.Serializable {
      ...
      static final class NUM_MEANS_0 implements java.io.Serializable {
        static final void fill(double[] sa) {
          sa[0] = 0.35936748862820206;
          sa[1] = 0.1805936078525258;
          sa[2] = 0.23883085946851795;
        }
      }
}
...
class NamesHolder_glm6 implements java.io.Serializable {
  public static final String[] VALUES = new String[3];
  static {
    NamesHolder_glm6_0.fill(VALUES);
  }
  static final class NamesHolder_glm6_0 implements java.io.Serializable {
